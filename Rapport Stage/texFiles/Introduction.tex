...
Cplex est une librairie\footref{librairie} qui permet la modélisation et la résolution de problème de programmation linéaire\footnote{Terme que j'expliquerais plus tard dans mon rapport}.
